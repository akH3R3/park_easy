      ...
      child: Shimmer.fromColors(
        ...
        child: Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              /// Top Row: P icon, title + action icons
              Row(
              ...
              Row(
                children: [
                  ...
                  Text('/hr •', style: TextStyle(color: Colors.grey[300])),
                  const SizedBox(width: 8),
                  Container(height: 14, width: 40, color: Colors.white), // slots
                  const SizedBox(width: 4),
                  Text('slots', style: TextStyle(color: Colors.grey[300])),
                ],
              ),
              const SizedBox(height: 14),
              ...
              Row(
                children: [
                  Icon(Icons.bar_chart, size: 18, color: Colors.white),
                  const SizedBox(width: 8),
